...
const Visita = () => {
  ...
  return (
    <>
      <Helmet>
        <title>La prima visita | Dr.ssa Sara Anna Polimeno</title>
        <meta
          name="description"
          content="Prima visita di un'ora con BIA AKERN 101, volta all'elaborazione di un piano alimentare personalizzato"
        />
      </Helmet>
      <div className="mt-6 md:mt-20 mb-10">
        ...
        <div className="container mx-4 md:mx-auto mt-12">
          <p className="mb-4">
            ...
            dello stato di salute sulla base di un approccio alimentare
            educativo.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            <strong>circa 1 ora</strong> dove il paziente verrà sottoposto ad
            un’
            <strong>
              anamnesi generale e intervista sullo stile di vita e alimentare
            </strong>
            , finalizzato alla conoscenza delle proprie abitudini;
            successivamente si effettua una valutazione corporea,
            antropometrica, plicometrica e bioimpedenziometrica tramite{" "}
            <strong>BIA AKERN 101</strong>, ossia uno dei migliori strumenti in
            commercio per l’analisi della composizione corporea (liquidi
            corporei intra ed extra cellulari, massa muscolare e massa grassa).
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            nutrirsi”, in quanto è il risultato di{" "}
            <strong>determinanti sociali, culturali e psicologiche</strong>.{" "}
            <br />A tal proposito la corretta alimentazione non è solo frutto di
            uno studio qualitativo e quantitativo ma deve armonizzarsi con la
            sfera psicologica e di relazione della persona.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            La prima visita dura circa <strong>1 ora</strong> e le successive
            visite di controllo durano 30 minuti. <br /> La durata del percorso
            nutrizionale è variabile a seconda delle esigenze di ogni singolo
            paziente.
          </p>
        </div>
        <Contacts />
