...
const ChiSono = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Chi Sono | Dr.ssa Sara Anna Polimeno</title>
        <meta
          name="description"
          content="Scopri di più su di me e sulla mia esperienza come biologo nutrizionista a Milano."
        />
      </Helmet>
          ...
          <div className="mx-4">
            ...
            >
              <p className="my-2">
                ...
                <strong>Biologo Nutrizionista a Milano</strong>. Ho conseguito
                la laurea in Nutrizione Clinica presso la Facoltà di Medicina e
              ...
              <p className="my-2">
                Durante il mio percorso universitario, ho concentrato i miei
                studi e tirocini in vari complessi ospedalieri della regione
                Lazio e in studi di nutrizione privati. In particolare, ho
                approfondito le tematiche legate alle{" "}
                <strong>malattie metaboliche</strong> come il{" "}
                <strong>diabete, l&apos;ipertensione e le dislipidemie</strong>,
                oltre alle <strong>malattie oncologiche</strong>. Ho compreso
                l&apos;importanza della nutrizione come strumento potente nella
                prevenzione e come supporto terapeutico per le persone già
                affette da tali patologie.
              </p>

              <p className="my-2">
                Al di là delle malattie, ho anche lavorato per guidare i
                pazienti verso una corretta{" "}
                <strong>educazione alimentare</strong>. Il mio obiettivo non è
                solo aiutare a raggiungere i risultati desiderati, ma anche
                correggere gli errori comuni commessi a tavola, al fine di
